...
3. **Tham khảo chi tiết hơn kiến thức về phần Parsing và Chunking tại**  ***[đây](5.parsing_chunking.md)***
---
...
2. **Vector store**
    ...
    ***Chi tiết hơn kiến thức về Vector Store có thể tham khảo tại [đây](5.vector_store.md)***
---
...
**Tiếp theo:** Cấu hình Roles cho AI Agent [phần tiếp theo](3.3.Bedrock-role.md) 🚀